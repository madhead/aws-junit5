...
To provide these values you need to imlement https://madhead.gitlab.io/aws-junit5/javadoc/me/madhead/aws_junit5/common/AWSEndpoint.html[`AWSEndpoint`].
...
Finally, put https://madhead.gitlab.io/aws-junit5/javadoc/me/madhead/aws_junit5/common/AWSClient.html[`AWSClient`] annotation on the fields to be injected.
...
* https://madhead.gitlab.io/aws-junit5/javadoc/me/madhead/aws_junit5/common/v1/AWSAdvancedConfiguration.html[`v1.AWSAdvancedConfiguration`]
+
Allows you to configure https://docs.aws.amazon.com/AWSJavaSDK/latest/javadoc/com/amazonaws/ClientConfiguration.html[`ClientConfiguration`] by implementing https://madhead.gitlab.io/aws-junit5/javadoc/me/madhead/aws_junit5/common/v1/ClientConfigurationFactory.html[`ClientConfigurationFactory`].
* https://madhead.gitlab.io/aws-junit5/javadoc/me/madhead/aws_junit5/common/v2/AWSAdvancedConfiguration.html[`v2.AWSAdvancedConfiguration`]
+
Allows you to configure:
+
** https://sdk.amazonaws.com/java/api/latest/software/amazon/awssdk/core/client/config/ClientOverrideConfiguration.html[`ClientOverrideConfiguration`] by implementing https://madhead.gitlab.io/aws-junit5/javadoc/me/madhead/aws_junit5/common/v2/ClientOverrideConfigurationFactory.html[`ClientOverrideConfigurationFactory`].
** https://sdk.amazonaws.com/java/api/latest/software/amazon/awssdk/http/SdkHttpClient.html[`SdkHttpClient`] by implementing https://madhead.gitlab.io/aws-junit5/javadoc/me/madhead/aws_junit5/common/v2/SdkHttpClientFactory.html[`SdkHttpClientFactory`].
** https://sdk.amazonaws.com/java/api/latest/software/amazon/awssdk/http/async/SdkAsyncHttpClient.html[`SdkAsyncHttpClient`] by implementing https://madhead.gitlab.io/aws-junit5/javadoc/me/madhead/aws_junit5/common/v2/SdkAsyncHttpClientFactory.html[`SdkAsyncHttpClientFactory`].
